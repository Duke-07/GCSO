...
function draw() {
  ...
  if (wall1.x - car1.x < car1.width / 2 + wall1.width / 2) {
    ...
    if (defor1 > 110) {
      ...
      fill("red");
      textSize(20);
      text("THIS CAR IS DANGEROUS TO DRIVE!!", 50, 100);
    }
  ...
  if (wall2.x - car2.x < car2.width / 2 + wall2.width / 2) {
    ...
    if (defor2 < 180 && defor2 > 70) {
      ...
      fill("orange");
      textSize(20);
      text("THIS CAR IS NOT SAFE TO DRIVE!!", 50, 250);
    }
  ...
  if (wall3.x - car3.x < car3.width / 2 + wall3.width / 2) {
    ...
    if (defor3 < 70 && defor3 > 50) {
      ...
      fill("yellow");
      textSize(20);
      text("THIS CAR IS AVERAGE TO DRIVE!!", 50, 440);
    }
  ...
  if (wall4.x - car4.x < car4.width / 2 + wall4.width / 2) {
    ...
    if (defor4 < 50) {
      ...
      fill("lime");
      textSize(20);
      text("THIS CAR IS SAFE TO DRIVE!!", 50, 600);
    }
  }
